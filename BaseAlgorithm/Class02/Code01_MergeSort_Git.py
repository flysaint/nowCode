# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 09:50:40 2019
...
初始： a = [2,6] b = [1,3] c = [] 第1步，顺序从a,b中取出一个数字：2,1 比较大小后放入c中，并将该数字从原list中删除，结果是： a = [2,6] b = [3] c = [1] 第2步，继续从a,b中按照顺序取出数字，也就是重复上面步骤，这次是：2,3 比较大小后放入c中，并将该数字从原list中删除，结果是： a = [6] b = [3] c = [1,2] 第3步,再重复前边的步骤,结果是： a = [6] b = [] c = [1,2,3] 最后一步，将6追加到c中，结果形成了： a = [] b = [] c = [1,2,3,6]
